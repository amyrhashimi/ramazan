    ...
    <div>
        <!-- title-->
        <h4 class="mt-0">ثبت نام</h4>
        <p class="text-muted mb-4">@lang('auth.message_register')</p>
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="checkbox-signup" wire:model.debounce.lazy='terms'>
                    <label class="form-check-label" for="checkbox-signup"><a href="javascript: void(0);" class=" @error('terms') text-danger @else text-dark @enderror ">@lang("auth.accept_terms")</a></label>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="text-center d-grid">
                <button class="btn btn-primary waves-effect waves-light" type="submit"> ثبت نام </button>
            </div>
            <!-- social-->
        ...
        <footer class="footer footer-alt">
            <p class="text-muted">@lang("auth.exist_account") <a href="{{ route('login') }}" class="text-muted ms-1"><b>@lang("auth.login")</b></a></p>
        </footer>
    </div>
